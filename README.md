...
[![My Skills](https://skillicons.dev/icons?i=cpp,javascript,typescript,git,python,r,tensorflow,nodejs,nestjs,laravel,ps,html,css,php,cs,java,react,nextjs,kali&theme=light)](https://skillicons.dev)
